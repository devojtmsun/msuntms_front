      ...
      <a-form :form="form">
            ...
            <div data-v-f49e88fc="" class="ant-row ant-form-item">
                <div class="ant-col-7 ant-form-item-label">
                    ...
                    <div class="ant-col-12 ant-form-item-control-wrapper">
                        <multiselect v-model="school_name" tag-placeholder="Add this as new school" placeholder="Search or add a school" 
                            label="school_name" 
            ...
            <a-form-item
                ...
                <a-select
                    ...
                    placeholder="Select your emergency contact if exist"
                    @change="handleSelectChangeEmrgncyContact"
                    :disabled='!ec_flag'
                >
                    <a-select-option v-for="ec in emergency_contacts " :key="ec.id">
                      {{ec.fname +' '+ ec.lname}}
                    </a-select-option>
                </a-select>
                <a-button
...
export default {
    ...
    async asyncData({params, error, $axios, store}) {
        ...
        try {
          ...
          let crs = ((Array.isArray(course.data.data) && course.data.datalength ) ? {course_text: course.data.data[0].course_text, id: course.data.data[0].id} : {})
          console.log(sc)
          return {
              // school_name: {school_name: school.data[0].school_name, id: school.data[0].id},
              school_name: sc,
              optionsCourse: course.data.data,
              oldCourse : course.data.data,
              optionsSchool: school.data.data,
              oldSchool : school.data.data,
              // course_text: {course_text: course.data[0].course_text, id: course.data[0].id},
              course_text: crs,
              emergency_contacts : emergency_contact.data.data,
  ...
  data () {
    return {
      ...
      buttonTitle: 'New',
      buttonType: 'add',
      // school_text: {school_text: '°C', text: `°C`},
      // optionsCourse: [
      //       { course_text: '°C', text: `°C` },
      //       { course_text: 'mg/L', text: `mg/L` },
      //   ],
      // optionsSchool: [
      //     { school_text: '°C', text: `°C` },
      //     { school_text: 'mg/L', text: `mg/L` },
      // ],
      // course_text: { course_text: '°C', text: `°C` },
      count: 5,
      // data: [],
      loading: false,
      visible: false,
   ...
   beforeCreate () {
    ...
    // this.form.getFieldDecorator('emergency_contact', { initialValue: this.emergency_contacts[0].fname +  this.emergency_contacts[0].lname});
  },
  methods: {
    moment,
      ...
      if(!this.ec_flag){
        ...
        if (!err) {
          console.log('Received values of form: ', moment(values.bdate._d).format('YYYY-MM-DD'));
                ...
                // let trainee_fname = values.fname
                // let trainee_lname = values.lname
                // let trainee_mname = values.mname
                // let trainee_bdate = moment(values.bdate._d).format('YYYY-MM-DD')
                // let trainee_home_add = values.home_add
                // let trainee_sex = values.sex
                // let trainee_contact_no = values.contact_no
                // let trainee_no_of_hrs = values.no_of_hrs
                // let purpose_of_stay = values.purpose_of_stay
              ...
              //  data.course_idcourse = (this.course_flag ? this.course_text.id : this.course_text.course_text)
              ...
              //  data.school_idschool = (this.school_flag ? this.school_name.id : this.school_name.school_name)
              ...
              let trainee = await this.$axios.post(`/trainee`,{
                  ...
                  course_idcourse : course_idcourse,
                  c_flag : this.course_flag,
                  c_course_text : course_text,
                  s_flag: this.school_flag,
                  s_school_name: s_school_name,
                  school_idschool : school_idschool,
              ...
              let resData = {
                ...
                CourseID : trainee.data.data.course_idcourse,
                course_text : trainee.data.data.course_text[0].course_text,
                EID : trainee.data.data.emergency_contact,
                ...
                SchoolID : trainee.data.data.school_idschool,
                ...
                school_idschool: trainee.data.data.school_idschool,
